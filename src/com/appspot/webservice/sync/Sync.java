 ...
 * on 2015-06-25 at 22:38:12 UTC 
 * Modify at your own risk.
 */

package com.appspot.webservice.sync;
...
public class Sync extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Comment {
     ...
     * sinhronizacije: Args: DATE_RESOURCE (type): endpoints.ResourceContainer vreme poslednje
     * sinhronizacije u formatu %Y-%m-%dT%H:%M:%S Returns: CommentMessageCollection (type):
    ...
    public class Syncdown extends SyncRequest<com.appspot.webservice.crud.model.MessagesCommentMessageCollection> {
       ...
       * poslednje sinhronizacije: Args: DATE_RESOURCE (type): endpoints.ResourceContainer vreme
       * poslednje sinhronizacije u formatu %Y-%m-%dT%H:%M:%S Returns: CommentMessageCollection (type):
       * messages.Message Izlazna poruka koja se salje klijentima
       *
       * Create a request for the method "comment.syncdown".
       *
       ...
       */
      protected Syncdown() {
        super(Sync.this, "GET", REST_PATH, null, com.appspot.webservice.crud.model.MessagesCommentMessageCollection.class);
      }
      ...
      public Syncdown setLastModified(java.lang.String lastModified) {
  ...
  public class Group {
    ...
    public class Syncdown extends SyncRequest<com.appspot.webservice.crud.model.MessagesGroupMessageCollection> {
       ...
       */
      protected Syncdown() {
        super(Sync.this, "GET", REST_PATH, null, com.appspot.webservice.crud.model.MessagesGroupMessageCollection.class);
      }
  ...
  public class Image {
    ...
    public class Syncdown extends SyncRequest<com.appspot.webservice.crud.model.MessagesImageMessageCollection> {
       ...
       */
      protected Syncdown() {
        super(Sync.this, "GET", REST_PATH, null, com.appspot.webservice.crud.model.MessagesImageMessageCollection.class);
      }
  ...
  public class Review {
    ...
    public class Syncdown extends SyncRequest<com.appspot.webservice.crud.model.MessagesReviewMessageCollection> {
       ...
       */
      protected Syncdown() {
        super(Sync.this, "GET", REST_PATH, null, com.appspot.webservice.crud.model.MessagesReviewMessageCollection.class);
      }
  ...
  public class Revobject {
    ...
    public class Syncdown extends SyncRequest<com.appspot.webservice.crud.model.MessagesReviewObjectMessageCollection> {
       ...
       */
      protected Syncdown() {
        super(Sync.this, "GET", REST_PATH, null, com.appspot.webservice.crud.model.MessagesReviewObjectMessageCollection.class);
      }
