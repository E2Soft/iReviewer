...
public final class MessagesGroupMessage extends com.google.api.client.json.GenericJson {
   ...
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key("reviews_changed")
  private com.google.api.client.util.DateTime reviewsChanged;
   ...
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key("users_changed")
  private com.google.api.client.util.DateTime usersChanged;
   ...
   */
  public MessagesGroupMessage setReviews(java.util.List<java.lang.String> reviews) {
   ...
   * @return value or {@code null} for none
   */
  public com.google.api.client.util.DateTime getReviewsChanged() {
    return reviewsChanged;
  }

  /**
   * @param reviewsChanged reviewsChanged or {@code null} for none
   */
  public MessagesGroupMessage setReviewsChanged(com.google.api.client.util.DateTime reviewsChanged) {
   ...
   */
  public MessagesGroupMessage setUsers(java.util.List<java.lang.String> users) {
    this.users = users;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public com.google.api.client.util.DateTime getUsersChanged() {
    return usersChanged;
  }

  /**
   * @param usersChanged usersChanged or {@code null} for none
   */
  public MessagesGroupMessage setUsersChanged(com.google.api.client.util.DateTime usersChanged) {
