...
public class Crud extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * <pre>
   *   {@code Crud crud = new Crud(...);}
   *   {@code Crud.Grouptoreview.List request = crud.grouptoreview().list(parameters ...)}
   * </pre>
   *
   * @return the resource collection
   */
  ...
  public class Grouptoreview {
    ...
    /**
     * Create a request for the method "grouptoreview.delete".
     *
     * This request holds the parameters needed by the crud server.  After setting any optional
     * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
     *
    ...
    public class Delete extends CrudRequest<Void> {
      ...
      private static final String REST_PATH = "grouptoreview";
    ...
    /**
     * Create a request for the method "grouptoreview.insert".
     *
     * This request holds the parameters needed by the crud server.  After setting any optional
     * parameters, call the {@link Insert#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.appspot.elevated_surge_702.crud.model.MessagesGroupToReviewMessageCollection}
     * @return the request
     */
    public Insert insert(com.appspot.elevated_surge_702.crud.model.MessagesGroupToReviewMessageCollection content) throws java.io.IOException {
      Insert result = new Insert(content);
      initialize(result);
      return result;
    }
    ...
    public class Insert extends CrudRequest<Void> {
       ...
       * @since 1.13
       */
      protected Insert(com.appspot.elevated_surge_702.crud.model.MessagesGroupToReviewMessageCollection content) {
        super(Crud.this, "POST", REST_PATH, content, Void.class);
      }
   ...
   * <pre>
   *   {@code Crud crud = new Crud(...);}
   *   {@code Crud.Grouptouser.List request = crud.grouptouser().list(parameters ...)}
   * </pre>
   *
   * @return the resource collection
   */
  ...
  public class Grouptouser {
    ...
    /**
     * Create a request for the method "grouptouser.delete".
     *
     * This request holds the parameters needed by the crud server.  After setting any optional
     * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
     *
    ...
    public class Delete extends CrudRequest<Void> {
      ...
      private static final String REST_PATH = "grouptouser";
    ...
    /**
     * Create a request for the method "grouptouser.insert".
     *
     * This request holds the parameters needed by the crud server.  After setting any optional
     * parameters, call the {@link Insert#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.appspot.elevated_surge_702.crud.model.MessagesGroupToUserMessageCollection}
     * @return the request
     */
    public Insert insert(com.appspot.elevated_surge_702.crud.model.MessagesGroupToUserMessageCollection content) throws java.io.IOException {
      Insert result = new Insert(content);
      initialize(result);
      return result;
    }
    ...
    public class Insert extends CrudRequest<Void> {
       ...
       * @since 1.13
       */
      protected Insert(com.appspot.elevated_surge_702.crud.model.MessagesGroupToUserMessageCollection content) {
        super(Crud.this, "POST", REST_PATH, content, Void.class);
      }
